...
<body class="expand-data panel-data">
  ...
  <div class="panel-content">
    <div class="widget">
            ...
            <table class="table table-striped table-bordered table-hover" width="100%" id="tourTableReport">
            </table>
  ...
  <script src="ProjectJs/reportsTour.js" type="text/javascript"></script>
