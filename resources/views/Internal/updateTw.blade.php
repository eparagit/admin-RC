...
<body class="expand-data panel-data">
  ...
  <div class="panel-content">
    <div class="widget pad50-65">
      ...
      <form class="form-wrp" id="info-form" method="POST" enctype="multipart/form-data"   action="{{route('updatewimgdate')}}" >
        ...
        <fieldset>
          ...
          <div class="row mrg20">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6" id="image_control" style="display:none">
              <span>Selccione una imágen</span>
              <input type="file" name="image" id="iamge" accept="image/*" class="brd-rd5 validate[required]" value="<?=$viajed['Imagen_Name']?>"  multiple>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12">
              <input class="brd-rd5 validate[required]" name="con_titulo" id="con_titulo" value="<?=$viajed['Titulo']?>" type="text"  />
              <span class="error-box"></span>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-6">
            <input class="brd-rd5 validate[required]" name="con_lsalida" id="con_lsalida" value="<?=$viajed['Lugar_Salida']?>"   type="text"  />
            <span class="error-box"></span>
          </div>
          <div class="col-md-6 col-sm-6 col-lg-6">
          <input class="brd-rd5 validate[required]" name="con_destino" id="con_destino" value="<?=$viajed['Destino']?>"  type="text" />
          <span class="error-box"></span>
        </div>
            <div class="col-md-12 col-sm-12 col-lg-12">
              <textarea class="brd-rd5 validate[required]" name="con_descripcion" id="con_descripcion" type="text"  ><?=$viajed['V_Descripcion']?></textarea>
              <span class="error-box"></span>
            </div>
             ...
             <div class="col-md-6 col-sm-6 col-lg-6">
               <span class="chck-bx">
                 ...
                 Tipo Viaje:<input class="brd-rd5 validate[required]" name="con_tvTemp" id="con_tvTemp" value="<?=$viajed['TV_Descripcion']?>" type="text"  disabled/>
             </div>
             <div class="col-md-6 col-sm-6 col-lg-6">
               <span class="chck-bx">
             ...
             Categoría Viaje:<input class="brd-rd5 validate[required]" name="con_cvTemp" id="con_cvTemp" value="<?=$viajed['CV_Descripcion']?>"  type="text"  disabled/>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6" id="selectTV" style="display:none">
                 ...
                 <div  class="slct-bx" >
                   <span>
                     <select  id="tviaje"  name="tviaje" >
                       <option value="<?=$viajed['ID_Tipo_Viaje']?>"><?=$viajed['TV_Descripcion']?></option>
                     </select>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6" id="selectCV" style="display:none">
                  ...
                  <div  class="slct-bx" >
                    <span>
                      <select  id="cviaje" name="cviaje" >
                        <option value="<?=$viajed['ID_Categoria']?>" id="optcv"><?=$viajed['CV_Descripcion']?></option>
                      </select>
        ...
        <fieldset>
          ...
          <div class="row mrg20">
            ...
            <div class="col-md-12 col-sm-12 col-lg-12">
              <textarea class="brd-rd5 validate[required]" name="con_requisitos" id="con_requisitos" type="text"  ><?=$viajed['Requisitos']?></textarea>
              <span class="error-box"></span>
            </div>
            <div class="col-md-12 col-sm-12 col-lg-12">
              <textarea class="brd-rd5 validate[email],required]" name="con_incluye" id="con_incluye"  type="text"   /><?=$viajed['Incluye']?></textarea>
              <span class="error-box"></span>
            </div>
            <div class="col-md-12 col-sm-12 col-lg-6">
              <input class="brd-rd5 validate[required]" name="con_cupo" id="con_cupo" type="number"  value="<?=$viajed['Cupo']?>" />
              <span class="error-box"></span>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-6">
              <input class="brd-rd5 validate[required]" name="con_costo" id="con_costo"  type="Text" placeholder="" value="<?=$viajed['Costo']?>"/>
              <span class="error-box"></span>
            </div>
              @endforeach
          </div>
        ...
        <fieldset>
          ...
          <span class="chck-bx">
            ...
            <label for="terms-policy">Agregue las fechas de salida, regreso y vencimiento del viaje
              <div class="col-md-12 col-sm-12 col-lg-12">
                <button id="" name="" class="green-bg brd-rd5" type="submit" >
                  <i class="fa fa-paper-plane"></i>Modificar Fechas</button>
              </div>
              <a class="blue-clr" href="" title="">Agregar Fechas</a>
            </label>
          </span>
 ...
 <div class="modal fade" id="cat-Modal" role="dialog">
  ...
  <script src="ProjectJs/tourUpdate.js" type="text/javascript"></script>
