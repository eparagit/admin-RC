...
<body class="expand-data panel-data">
  ...
  <div class="panel-content">
    <div class="widget pad50-65">
      ...
      <form class="form-wrp" id="info-form" method="POST" enctype="multipart/form-data" class="form-wrp" id="formImgInp" action="{{route('image.add')}}">
        {!! csrf_field() !!}
        <fieldset>
          ...
          <div class="row mrg20">
            <div class="col-md-6 col-sm-6 col-lg-6">
              ...
              <input class="brd-rd5 validate[required]" name="titulo" id="con_titulo" type="text" placeholder="Titulo*" />
              <span class="error-box"></span>
            </div>
            <div class="col-md-12 col-sm-6 col-lg-12">
              <textarea class="brd-rd5 validate[required]" name="descripcion" id="con_descripcion" type="text" placeholder="Descripción*" ></textarea>
              <span class="error-box"></span>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-6">
        ...
        <fieldset>
          ...
          <div class="row mrg20">
            <div class="col-md-12 col-sm-12 col-lg-12">
              <textarea class="brd-rd5 validate[required]" name="requisitos" id="con_requisitos" type="text" placeholder="Requisitos*" ></textarea>
              <span class="error-box"></span>
            </div>
            <div class="col-md-12 col-sm-12 col-lg-12">
              <textarea class="brd-rd5 validate[email],required]" name="incluye" id="con_incluye" type="email" placeholder="Incluye*" /></textarea>
              <span class="error-box"></span>
            </div>
            <div class="col-md-12 col-sm-12 col-lg-6">
              <input class="brd-rd5 validate[required]" name="cupo" id="con_cupo" type="number" placeholder="Cupo*" />
              <span class="error-box"></span>
            </div>
            <div class="col-md-6 col-sm-6 col-lg-6">
              <input class="brd-rd5 validate[required]" name="costo" id="con_costo" type="Text" placeholder="Costo*"
              />
              <span class="error-box"></span>
            </div>
          </div>
