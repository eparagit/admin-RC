...
<body class="expand-data panel-data">
   ...
   <div class="panel-content" id="frm_evType">
     <div class="widget pad50-65">
       <div class="widget-title2">
         <h4>Administración de Tipos de Evento</h4>
       </div>
       <form class="form-wrp">
         <div class="row mrg20">
       ...
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           ...
           <div class="modal-body">
             ...
             <input class="brd-rd5 validate[required]" name="con_desevnt" id="con_desevnt"  type="text"  />
