...
<body class="expand-data panel-data">
   ...
   <div class="pg-tp">
     ...
     <div class="pr-tp-inr">
       ...
       <span>Evaluación de Reservaciones</span>
     </div>
   </div>
   <!-- Page Top -->

   <div class="panel-content" id="frm_booking">
     <div class="widget pad50-65">
       <div class="widget-title2">
         <h4>Reservaciones</h4>
       </div>
       <form class="form-wrp">
         <div class="row mrg20" id="con_Rcontent">
       ...
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           ...
           <div class="modal-body">
             ...
             <textarea class="brd-rd5 validate[required]" name="p_justDesb" id="p_justDesb"  type="text"></textarea>
         ...
         <div class="modal-dialog" role="document">
           <div class="modal-content">
             ...
             <div class="modal-body">
               ...
               <input class="brd-rd5 validate[required]" name="r_justDesb" id="r_justDesb"  type="text"  />
               <span class="error-box"></span>
             </div>
             </div>
             <div class="modal-footer">
   ...
   <!-- Panel Content -->
    ...
    <script src="ProjectJs/rbooking.js" type="text/javascript"></script>
